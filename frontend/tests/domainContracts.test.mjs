...
const samples = {
  ...
  FeedbackEvent: {
    ...
    targetId: "variant-revision-1",
    platform: "linkedin",
    feedbackKind: "changes_requested",
    structuredReason: {
      code: "owner_style_request",
      observations: [{
        ...
        direction: "support",
        weight: 0.8,
        reason: "The owner asked for less promotional framing.",
      }],
    },
    beforeRevisionId: "variant-revision-1",
    afterRevisionId: null,
    learningEligibility: "eligible",
    createdAt: "2026-08-17T13:16:00.000Z",
  },
  StyleMemoryHypothesis: {
    styleMemoryId: "style-memory-1",
    workspaceId: "workspace-1",
    userId: "user-1",
    hypothesisKey: "tone.restrained_over_promotional",
    hypothesis: "Prefer restrained, concrete language over promotional hype.",
    category: "promotion",
    scope: { type: "platform", platform: "linkedin", projectId: null },
    confidence: 0.71,
    evidenceCount: 2,
    supportingFeedbackEventIds: ["feedback-1", "feedback-2"],
    contradictingFeedbackEventIds: [],
    exampleApprovedRevisionIds: ["variant-revision-1"],
    exampleRejectedRevisionIds: [],
    status: "active",
    lastEvaluatedAt: "2026-08-17T13:17:00.000Z",
    createdAt: "2026-08-17T13:16:00.000Z",
    updatedAt: "2026-08-17T13:17:00.000Z",
  },
