import { createContentPlanningApplication } from "./contentPlanningApplication.mjs";
...
export function createBrowserContentPlanningApplication({
  getStorage,
  ...
  return createContentPlanningApplication({
